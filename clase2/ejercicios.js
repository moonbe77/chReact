...
let response = findUser(users)
console.log(response)

console.log("--------------X NAME-----------------")

function findUserXname (u, nameToFind){    
    return u.find(function(u){
        return (u.name == nameToFind)
    })
}

let response2 = findUserXname(users, "Mrs. Dennis Schulist")
...
let response3 = findUsesXlat(users)
